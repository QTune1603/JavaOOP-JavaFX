...
// Draw second hand
            ...
            sLine.setStroke(javafx.scene.paint.Color.RED);
            ...
            mLine.setStroke(javafx.scene.paint.Color.BLUE);
// Draw hour hand
            ...
            hLine.setStroke(javafx.scene.paint.Color.GREEN);
            getChildren().clear();
    ...
    public class DisplayClock extends Application {
        ...
        public void start(Stage primaryStage) {
            Scene scene = new Scene(new ClockPane(), 400, 400);
